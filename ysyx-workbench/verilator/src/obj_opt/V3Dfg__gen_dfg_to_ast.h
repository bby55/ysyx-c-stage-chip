...
void visit(DfgAcosD* vtxp) override {
    AstNodeExpr* const op1p = convertSource(vtxp->source<0>());
...
void visit(DfgAdd* vtxp) override {
    AstNodeExpr* const op1p = convertSource(vtxp->source<0>());
    AstNodeExpr* const op2p = convertSource(vtxp->source<1>());
...
void visit(DfgCond* vtxp) override {
    AstNodeExpr* const op1p = convertSource(vtxp->source<0>());
    AstNodeExpr* const op2p = convertSource(vtxp->source<1>());
    AstNodeExpr* const op3p = convertSource(vtxp->source<2>());
