module ysyx_25010028_IDU (
  ...
  output           o_is_loadmemory,
  output           o_is_storememory,
  output           o_RegWen
);
...
assign o_is_loadmemory  = is_loadmemory;
assign o_is_storememory = is_storememory;
assign o_RegWen   = ((i_lsu_rlast) || (~is_loadmemory && ~is_storememory && i_ifu_rlast)) && reg_wen;
assign o_Imm      = Imm;
