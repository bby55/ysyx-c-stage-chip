...
extern "C" {
    ...
    // DPI IMPORTS
    // DPI import at vsrc/rv32e.v:3:30
    extern void display(int instr, int pc, int npc);
    // DPI import at vsrc/rv32e.v:5:30
