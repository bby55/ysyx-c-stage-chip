...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[0U])) {
        ...
        bufp->chgIData(oldp+218,(vlSelf->top__DOT__u_regfile__DOT__mvendorid),32);
        bufp->chgIData(oldp+219,(vlSelf->top__DOT__u_regfile__DOT__marchid),32);
        bufp->chgIData(oldp+220,(vlSelf->top__DOT__u_regfile__DOT__unnamedblk1__DOT__i),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgIData(oldp+221,(vlSelf->top__DOT__pc),32);
        bufp->chgIData(oldp+222,(vlSelf->top__DOT__pc_next),32);
        bufp->chgIData(oldp+223,(vlSelf->top__DOT__instr),32);
        bufp->chgSData(oldp+224,(vlSelf->top__DOT__instr_type),12);
        bufp->chgCData(oldp+225,((0x7fU & vlSelf->top__DOT__instr)),7);
        bufp->chgCData(oldp+226,((7U & (vlSelf->top__DOT__instr 
                                        >> 0xcU))),3);
        bufp->chgCData(oldp+227,((vlSelf->top__DOT__instr 
                                  >> 0x19U)),7);
        bufp->chgCData(oldp+228,((0x1fU & (vlSelf->top__DOT__instr 
                                           >> 0xfU))),5);
        bufp->chgCData(oldp+229,((0x1fU & (vlSelf->top__DOT__instr 
                                           >> 0x14U))),5);
        bufp->chgCData(oldp+230,((0x1fU & (vlSelf->top__DOT__instr 
                                           >> 7U))),5);
        bufp->chgIData(oldp+231,(vlSelf->top__DOT__imm),32);
        bufp->chgSData(oldp+232,((vlSelf->top__DOT__instr 
                                  >> 0x14U)),12);
        bufp->chgIData(oldp+233,(vlSelf->top__DOT__J_imm),20);
        bufp->chgSData(oldp+234,(vlSelf->top__DOT__B_imm),12);
        bufp->chgSData(oldp+235,(vlSelf->top__DOT__S_imm),12);
        bufp->chgIData(oldp+236,((vlSelf->top__DOT__instr 
                                  >> 0xcU)),20);
        bufp->chgIData(oldp+237,(vlSelf->top__DOT__I_ex),32);
        bufp->chgIData(oldp+238,(vlSelf->top__DOT__S_ex),32);
        bufp->chgIData(oldp+239,(vlSelf->top__DOT__J_ex),32);
        bufp->chgIData(oldp+240,((0xfffff000U & vlSelf->top__DOT__instr)),32);
        bufp->chgIData(oldp+241,(vlSelf->top__DOT__B_ex),32);
        bufp->chgIData(oldp+242,(vlSelf->top__DOT__rs1_data),32);
        bufp->chgIData(oldp+243,(vlSelf->top__DOT__rs2_data),32);
        bufp->chgIData(oldp+244,(vlSelf->top__DOT__u_regfile__DOT__mcause),32);
        bufp->chgIData(oldp+245,(vlSelf->top__DOT__u_regfile__DOT__mepc),32);
        bufp->chgIData(oldp+246,(vlSelf->top__DOT__u_regfile__DOT__mtvec),32);
        bufp->chgIData(oldp+247,(vlSelf->top__DOT__u_regfile__DOT__mstatus),32);
        bufp->chgSData(oldp+248,(vlSelf->top__DOT__csr),12);
        bufp->chgIData(oldp+249,(vlSelf->top__DOT__t),32);
        bufp->chgIData(oldp+250,(((0x80000000U > vlSelf->top__DOT__pc)
                                   ? (vlSelf->top__DOT__pc 
                                      >> 2U) : ((vlSelf->top__DOT__pc 
                                                 - (IData)(0x80000000U)) 
                                                >> 2U))),32);
        bufp->chgBit(oldp+251,(vlSelf->top__DOT__wen));
        bufp->chgSData(oldp+252,(vlSelf->top__DOT__opcode_funct3),10);
        bufp->chgIData(oldp+253,(vlSelf->top__DOT__opcode_funct3_funct7),17);
        bufp->chgIData(oldp+254,(vlSelf->top__DOT__u_regfile__DOT__rf
                                 [0xaU]),32);
        bufp->chgIData(oldp+255,(vlSelf->top__DOT__csr_val),32);
        bufp->chgIData(oldp+256,(((IData)(vlSelf->top__DOT__valid)
                                   ? vlSelf->top__DOT____VdfgTmp_h2f2dbb37__0
                                   : 0x80000000U)),32);
        bufp->chgIData(oldp+257,(((IData)(vlSelf->top__DOT__wen_ram)
                                   ? vlSelf->top__DOT____VdfgTmp_h2f2dbb37__0
                                   : 0x80000000U)),32);
        bufp->chgCData(oldp+258,(((0x10U == (IData)(vlSelf->top__DOT__instr_type))
                                                 ...
                                                 ((1U 
                                                  ...
                                                  ((2U 
                                                   ...
                                                   ((3U 
                                                     ...
                                                     ? 8U
                                                     : 0U))))))),8);
        bufp->chgCData(oldp+259,(((IData)(vlSelf->top__DOT____VdfgTmp_hb37fddff__0)
                                   ? 0xcU : 3U)),8);
        bufp->chgBit(oldp+260,(vlSelf->top__DOT__valid));
        bufp->chgBit(oldp+261,(vlSelf->top__DOT__wen_ram));
        bufp->chgSData(oldp+262,(vlSelf->top__DOT__instr_type_tmp),12);
        bufp->chgSData(oldp+263,(vlSelf->top__DOT__instr_type_nofunct),12);
        bufp->chgSData(oldp+264,(vlSelf->top__DOT__instr_type_funct7),12);
        bufp->chgSData(oldp+265,(vlSelf->top__DOT__instr_type_csr),12);
        bufp->chgSData(oldp+266,(vlSelf->top__DOT__i0__DOT__i0__DOT__lut_out),12);
        bufp->chgBit(oldp+267,(vlSelf->top__DOT__i0__DOT__i0__DOT__hit));
        bufp->chgWData(oldp+268,(vlSelf->top__DOT____Vcellinp__i1____pinNumber4),1760);
        bufp->chgIData(oldp+323,(vlSelf->top__DOT__i1__DOT__i0__DOT__lut_out),32);
        bufp->chgBit(oldp+324,(vlSelf->top__DOT__i1__DOT__i0__DOT__hit));
        ...
        __Vtemp_hfe816ff6__0[5U] = (0x10U | (vlSelf->top__DOT__u_regfile__DOT__mepc 
                                             >> 0x1cU));
        bufp->chgWData(oldp+325,(__Vtemp_hfe816ff6__0),176);
        bufp->chgQData(oldp+331,(vlSelf->top__DOT__i10__DOT__i0__DOT__pair_list[0]),44);
        bufp->chgQData(oldp+333,(vlSelf->top__DOT__i10__DOT__i0__DOT__pair_list[1]),44);
        bufp->chgQData(oldp+335,(vlSelf->top__DOT__i10__DOT__i0__DOT__pair_list[2]),44);
        bufp->chgQData(oldp+337,(vlSelf->top__DOT__i10__DOT__i0__DOT__pair_list[3]),44);
        bufp->chgIData(oldp+339,(vlSelf->top__DOT__i10__DOT__i0__DOT__data_list[0]),32);
        bufp->chgIData(oldp+340,(vlSelf->top__DOT__i10__DOT__i0__DOT__data_list[1]),32);
        bufp->chgIData(oldp+341,(vlSelf->top__DOT__i10__DOT__i0__DOT__data_list[2]),32);
        bufp->chgIData(oldp+342,(vlSelf->top__DOT__i10__DOT__i0__DOT__data_list[3]),32);
        bufp->chgIData(oldp+343,(vlSelf->top__DOT__i10__DOT__i0__DOT__lut_out),32);
        bufp->chgBit(oldp+344,(vlSelf->top__DOT__i10__DOT__i0__DOT__hit));
        bufp->chgBit(oldp+345,(vlSelf->top__DOT__i2__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+346,(vlSelf->top__DOT__i2__DOT__i0__DOT__hit));
        bufp->chgIData(oldp+347,(((IData)(4U) + vlSelf->top__DOT__pc)),32);
        ...
        __Vtemp_h578d3fd9__0[0xdU] = (0x1000U | (((0x80000000U 
                                                  ...
                                                  ((IData)(0x80000000U) 
                                                   ...
                                                   : vlSelf->top__DOT____VdfgTmp_h2f2dbb37__0) 
                                                 >> 0x14U));
        bufp->chgWData(oldp+348,(__Vtemp_h578d3fd9__0),440);
        bufp->chgQData(oldp+362,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[0]),44);
        bufp->chgQData(oldp+364,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[1]),44);
        bufp->chgQData(oldp+366,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[2]),44);
        bufp->chgQData(oldp+368,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[3]),44);
        bufp->chgQData(oldp+370,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[4]),44);
        bufp->chgQData(oldp+372,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[5]),44);
        bufp->chgQData(oldp+374,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[6]),44);
        bufp->chgQData(oldp+376,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[7]),44);
        bufp->chgQData(oldp+378,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[8]),44);
        bufp->chgQData(oldp+380,(vlSelf->top__DOT__i3__DOT__i0__DOT__pair_list[9]),44);
        bufp->chgIData(oldp+382,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[0]),32);
        bufp->chgIData(oldp+383,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[1]),32);
        bufp->chgIData(oldp+384,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[2]),32);
        bufp->chgIData(oldp+385,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[3]),32);
        bufp->chgIData(oldp+386,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[4]),32);
        bufp->chgIData(oldp+387,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[5]),32);
        bufp->chgIData(oldp+388,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[6]),32);
        bufp->chgIData(oldp+389,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[7]),32);
        bufp->chgIData(oldp+390,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[8]),32);
        bufp->chgIData(oldp+391,(vlSelf->top__DOT__i3__DOT__i0__DOT__data_list[9]),32);
        bufp->chgIData(oldp+392,(vlSelf->top__DOT__i3__DOT__i0__DOT__lut_out),32);
        bufp->chgBit(oldp+393,(vlSelf->top__DOT__i3__DOT__i0__DOT__hit));
        bufp->chgBit(oldp+394,(vlSelf->top__DOT__i4__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+395,(vlSelf->top__DOT__i4__DOT__i0__DOT__hit));
        bufp->chgBit(oldp+396,(vlSelf->top__DOT__i5__DOT__i0__DOT__lut_out));
        bufp->chgBit(oldp+397,(vlSelf->top__DOT__i5__DOT__i0__DOT__hit));
        bufp->chgSData(oldp+398,(vlSelf->top__DOT__i6__DOT__i0__DOT__lut_out),12);
        bufp->chgBit(oldp+399,(vlSelf->top__DOT__i6__DOT__i0__DOT__hit));
        bufp->chgSData(oldp+400,(vlSelf->top__DOT__i7__DOT__i0__DOT__lut_out),12);
        bufp->chgBit(oldp+401,(vlSelf->top__DOT__i7__DOT__i0__DOT__hit));
        bufp->chgSData(oldp+402,(vlSelf->top__DOT__i8__DOT__i0__DOT__lut_out),12);
        bufp->chgBit(oldp+403,(vlSelf->top__DOT__i8__DOT__i0__DOT__hit));
        bufp->chgSData(oldp+404,(vlSelf->top__DOT__i9__DOT__i0__DOT__lut_out),12);
        bufp->chgBit(oldp+405,(vlSelf->top__DOT__i9__DOT__i0__DOT__hit));
        bufp->chgCData(oldp+406,(vlSelf->top__DOT__u_alu__DOT__byte_idx),2);
        bufp->chgIData(oldp+407,(vlSelf->top__DOT__u_regfile__DOT__rf[0]),32);
        bufp->chgIData(oldp+408,(vlSelf->top__DOT__u_regfile__DOT__rf[1]),32);
        bufp->chgIData(oldp+409,(vlSelf->top__DOT__u_regfile__DOT__rf[2]),32);
        bufp->chgIData(oldp+410,(vlSelf->top__DOT__u_regfile__DOT__rf[3]),32);
        bufp->chgIData(oldp+411,(vlSelf->top__DOT__u_regfile__DOT__rf[4]),32);
        bufp->chgIData(oldp+412,(vlSelf->top__DOT__u_regfile__DOT__rf[5]),32);
        bufp->chgIData(oldp+413,(vlSelf->top__DOT__u_regfile__DOT__rf[6]),32);
        bufp->chgIData(oldp+414,(vlSelf->top__DOT__u_regfile__DOT__rf[7]),32);
        bufp->chgIData(oldp+415,(vlSelf->top__DOT__u_regfile__DOT__rf[8]),32);
        bufp->chgIData(oldp+416,(vlSelf->top__DOT__u_regfile__DOT__rf[9]),32);
        bufp->chgIData(oldp+417,(vlSelf->top__DOT__u_regfile__DOT__rf[10]),32);
        bufp->chgIData(oldp+418,(vlSelf->top__DOT__u_regfile__DOT__rf[11]),32);
        bufp->chgIData(oldp+419,(vlSelf->top__DOT__u_regfile__DOT__rf[12]),32);
        bufp->chgIData(oldp+420,(vlSelf->top__DOT__u_regfile__DOT__rf[13]),32);
        bufp->chgIData(oldp+421,(vlSelf->top__DOT__u_regfile__DOT__rf[14]),32);
        bufp->chgIData(oldp+422,(vlSelf->top__DOT__u_regfile__DOT__rf[15]),32);
        bufp->chgIData(oldp+423,(vlSelf->top__DOT__u_regfile__DOT__rf[16]),32);
        bufp->chgIData(oldp+424,(vlSelf->top__DOT__u_regfile__DOT__rf[17]),32);
        bufp->chgIData(oldp+425,(vlSelf->top__DOT__u_regfile__DOT__rf[18]),32);
        bufp->chgIData(oldp+426,(vlSelf->top__DOT__u_regfile__DOT__rf[19]),32);
        bufp->chgIData(oldp+427,(vlSelf->top__DOT__u_regfile__DOT__rf[20]),32);
        bufp->chgIData(oldp+428,(vlSelf->top__DOT__u_regfile__DOT__rf[21]),32);
        bufp->chgIData(oldp+429,(vlSelf->top__DOT__u_regfile__DOT__rf[22]),32);
        bufp->chgIData(oldp+430,(vlSelf->top__DOT__u_regfile__DOT__rf[23]),32);
        bufp->chgIData(oldp+431,(vlSelf->top__DOT__u_regfile__DOT__rf[24]),32);
        bufp->chgIData(oldp+432,(vlSelf->top__DOT__u_regfile__DOT__rf[25]),32);
        bufp->chgIData(oldp+433,(vlSelf->top__DOT__u_regfile__DOT__rf[26]),32);
        bufp->chgIData(oldp+434,(vlSelf->top__DOT__u_regfile__DOT__rf[27]),32);
        bufp->chgIData(oldp+435,(vlSelf->top__DOT__u_regfile__DOT__rf[28]),32);
        bufp->chgIData(oldp+436,(vlSelf->top__DOT__u_regfile__DOT__rf[29]),32);
        bufp->chgIData(oldp+437,(vlSelf->top__DOT__u_regfile__DOT__rf[30]),32);
        bufp->chgIData(oldp+438,(vlSelf->top__DOT__u_regfile__DOT__rf[31]),32);
        bufp->chgIData(oldp+439,(vlSelf->top__DOT__u_regfile__DOT__mcycle),32);
        bufp->chgIData(oldp+440,(vlSelf->top__DOT__u_regfile__DOT__mcycleh),32);
        bufp->chgIData(oldp+441,(((0U == vlSelf->top__DOT__u_regfile__DOT__rf
                                   [0xfU]) ? ((IData)(4U) 
                                              + vlSelf->top__DOT__pc)
                                   : vlSelf->top__DOT__pc)),32);
    }
    bufp->chgBit(oldp+442,(vlSelf->clk));
    bufp->chgBit(oldp+443,(vlSelf->reset));
    bufp->chgIData(oldp+444,(vlSelf->top__DOT__rd_data),32);
    bufp->chgIData(oldp+445,(vlSelf->top__DOT__rdata),32);
    bufp->chgIData(oldp+446,(((3U == (IData)(vlSelf->top__DOT__instr_type))
