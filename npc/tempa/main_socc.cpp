...
extern "C" int rom_read(int raddr) {
    if(raddr >= 0x20000000) raddr = raddr - 0x20000000;
...
int main(int argc, char** argv) {
    ...
    time(&rtc_timep);
    rtc_tm = gmtime(&rtc_timep);
    const char* hello_rom_path = "/home/ysyxbby/ysyx-workbench/ysyxSoC_chip/ready-to-run/D-stage/new";
