...
VL_INLINE_OPT void Vmux___024root___ico_sequent__TOP__0(Vmux___024root* vlSelf) {
    ...
    vlSelf->mux__DOT__i0__DOT__i0__DOT__hit = ((IData)(vlSelf->mux__DOT__i0__DOT__i0__DOT__hit) 
                                               | ((IData)(vlSelf->s) 
                                                  ...
                                                  vlSelf->mux__DOT__i0__DOT__i0__DOT__key_list
                                                  [3U]));
    vlSelf->y = ((IData)(vlSelf->mux__DOT__i0__DOT__i0__DOT__hit)
                  ? (IData)(vlSelf->mux__DOT__i0__DOT__i0__DOT__lut_out)
                  : 0U);
}
...
#endif
                VL_FATAL_MT("vsrc/mux.v", 54, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/mux.v", 54, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/mux.v", 54, "", "NBA region did not converge.");
            }
