...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if ((0xffffffffU != vlSelf->top__DOT__u_regfile__DOT__mcycle)) {
        vlSelf->top__DOT__u_regfile__DOT__mcycle = 
            ((IData)(1U) + vlSelf->top__DOT__u_regfile__DOT__mcycle);
    } else if ((0xffffffffU != vlSelf->top__DOT__u_regfile__DOT__mcycleh)) {
        vlSelf->top__DOT__u_regfile__DOT__mcycleh = 
            ((IData)(1U) + vlSelf->top__DOT__u_regfile__DOT__mcycleh);
    } else {
        vlSelf->top__DOT__u_regfile__DOT__mcycle = 0U;
        vlSelf->top__DOT__u_regfile__DOT__mcycleh = 0U;
    }
    ...
    if ((0x24U == (IData)(vlSelf->top__DOT__instr_type))) {
        vlSelf->top__DOT__u_regfile__DOT__mcause = 
            vlSelf->top__DOT__u_regfile__DOT__rf[0xfU];
