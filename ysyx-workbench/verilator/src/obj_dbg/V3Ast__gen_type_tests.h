...
template<> inline bool AstNode::privateTypeTest<AstTracePopNamePrefix>(const AstNode* nodep) { return nodep->type() == VNType::atTracePopNamePrefix; }
template<> inline bool AstNode::privateTypeTest<AstTracePushNamePrefix>(const AstNode* nodep) { return nodep->type() == VNType::atTracePushNamePrefix; }
