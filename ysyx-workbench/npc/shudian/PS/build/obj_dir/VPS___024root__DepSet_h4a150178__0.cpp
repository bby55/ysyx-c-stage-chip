            ...
            if ((0xaU == (IData)(vlSelf->PS__DOT__count))) {
                if ((((~ (IData)(vlSelf->PS__DOT__MY_PS__DOT__buffer)) 
                     ...
                     & VL_REDXOR_32((0x1ffU & ((IData)(vlSelf->PS__DOT__MY_PS__DOT__buffer) 
                                               >> 1U))))) {
                    if ((0U == (IData)(vlSelf->PS__DOT__MY_PS__DOT__state))) {
                        vlSelf->PS__DOT__MY_PS__DOT__seal = 0U;
                        vlSelf->PS__DOT__MY_PS__DOT__next_state 
                            = ((0xf0U == (0xffU & ((IData)(vlSelf->PS__DOT__MY_PS__DOT__buffer) 
                                                   >> 1U)))
                                ? 1U : 0U);
                    } else if ((1U == (IData)(vlSelf->PS__DOT__MY_PS__DOT__state))) {
                        vlSelf->PS__DOT__MY_PS__DOT__seal = 1U;
                        vlSelf->PS__DOT__MY_PS__DOT__next_state 
                            = ((0xf0U == (0xffU & ((IData)(vlSelf->PS__DOT__MY_PS__DOT__buffer) 
                                                   >> 1U)))
                                ? 1U : 2U);
                    } else {
                        vlSelf->PS__DOT__MY_PS__DOT__seal 
                            = ((2U == (IData)(vlSelf->PS__DOT__MY_PS__DOT__state))
                                ? 2U : 0U);
                        vlSelf->PS__DOT__MY_PS__DOT__next_state = 0U;
                    }
                    if ((0xf0U == (0xffU & ((IData)(vlSelf->PS__DOT__MY_PS__DOT__buffer) 
                                            >> 1U)))) {
                        vlSelf->num = (0xffU & ((IData)(1U) 
                                                + (IData)(vlSelf->num)));
                    }
                    if (((2U == (IData)(vlSelf->PS__DOT__MY_PS__DOT__state)) 
                         | (0U == (IData)(vlSelf->PS__DOT__MY_PS__DOT__seal)))) {
                ...
                vlSelf->PS__DOT__MY_PS__DOT____Vlvbound_he42a8c0b__0 
                    = vlSelf->ps2_data;
                if ((9U >= (IData)(vlSelf->PS__DOT__count))) {
...
VL_INLINE_OPT void VPS___024root___nba_sequent__TOP__1(VPS___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VPS__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPS___024root___nba_sequent__TOP__1\n"); );
    // Body
    vlSelf->PS__DOT__MY_PS__DOT__state = ((IData)(vlSelf->rst)
                                           ? (IData)(vlSelf->PS__DOT__MY_PS__DOT__next_state)
                                           : 0U);
}
...
void VPS___024root___eval_nba(VPS___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VPS___024root___nba_sequent__TOP__1(vlSelf);
    }
}
...
#endif
                    VL_FATAL_MT("/home/ysyxbby/ysyx-workbench/npc/shudian/PS/vsrc/PS.v", 173, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/ysyxbby/ysyx-workbench/npc/shudian/PS/vsrc/PS.v", 173, "", "NBA region did not converge.");
            }
