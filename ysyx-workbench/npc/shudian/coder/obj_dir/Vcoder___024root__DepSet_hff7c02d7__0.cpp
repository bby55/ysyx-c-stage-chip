...
extern const VlUnpacked<CData/*3:0*/, 512> Vcoder__ConstPool__TABLE_h0a8d08b3_0;
extern const VlUnpacked<IData/*31:0*/, 512> Vcoder__ConstPool__TABLE_h0da5e76f_0;
...
VL_INLINE_OPT void Vcoder___024root___ico_sequent__TOP__0(Vcoder___024root* vlSelf) {
    ...
    vlSelf->seal = Vcoder__ConstPool__TABLE_h934a15ab_0
        [__Vtableidx1];
    vlSelf->coder__DOT__temp = Vcoder__ConstPool__TABLE_hc7cb9ab7_0
        [__Vtableidx1];
    if ((8U & Vcoder__ConstPool__TABLE_h0a8d08b3_0[__Vtableidx1])) {
        vlSelf->coder__DOT__i = Vcoder__ConstPool__TABLE_h0da5e76f_0
            [__Vtableidx1];
    }
    __Vtableidx6 = vlSelf->seal;
    vlSelf->h3 = Vcoder__ConstPool__TABLE_hb2a417e2_0
        [__Vtableidx6];
    __Vtableidx2 = vlSelf->coder__DOT__temp;
...
#endif
                VL_FATAL_MT("vsrc/coder.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/coder.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/coder.v", 1, "", "NBA region did not converge.");
            }
